...
7. verifica as tabelas `control_schema_migrations`, `publications`, `publication_files`, `versions`, `executions`, `execution_configurations`, `execution_steps`, `file_loads` e `execution_events`;
